...
if __name__ == "__main__":
    ...
    params1 = np.array([7.737922e+13, 1.551463e+14, -3.152439e+13,
                       -1.365589e+06, -1.426612e+05, 1.881717e+05, 5.363167e26])
                      
    params2 = np.array([4.554420e+13, 2.407766e+13, 1.816313e+14,
                       -1.365589e+06, -1.426612e+05, 1.881717e+05, 5.363167e26])
                      
    params3 = np.array([1.817152e+14, -1.669893e+13, 1.019937e+14,
                       -6.625891e+05, -2.973421e+05, 1.056385e+06, 5.363167e26])  # [x0, y0, z0, vx0, vy0, vz0, mu]

    t = np.linspace(T0, T0 + 15 * Y, 15 + 1)
    obs = gen_obs(params1, t)

    gn = gauss_newton(dynamic_law, params_dim=7, state_dim=6, obs_dim=2, h=0.001 * Y)
  
    # Начальное приближение 
    init_params = np.array([7.037922e+13, 1.651463e+14, -3.452439e+13,
                           -1.265589e+06, -1.526612e+05, 1.781717e+05, 6.063167e26]) # Масса на 13 % больше
    
    #init_params = np.array([7.037922e+13, 1.651463e+14, -3.452439e+13,
    #                      -1.265589e+06, -1.526612e+05, 1.781717e+05, 6.063167e26]) # Масса на 15 % меньше
    
    print("Начальное приближение: ", init_params)
    print("Отклонение начального приближения: ", (init_params - params1) / params1)
    
    estimated_params = gn.fit(t, obs, init_params, max_iterations=100)
    
    print("Истинные параметры: \n", params1)
    print("Оцененные параметры: \n", estimated_params)
    print("Количество итераций: ", gn.iteration)
    
    accuracy = np.linalg.norm(estimated_params - params1) / np.linalg.norm(params1)
